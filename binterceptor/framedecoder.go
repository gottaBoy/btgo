...
//
// biface.LengthField has many configuration parameters so
...
//
// biface.LengthField 有许多配置参数，因此它可以解码任何具有长度字段的消息，
// 这在专有的客户端-服务器协议中经常见到。
//
...
type FrameDecoder struct {
	biface.LengthField //从ILengthField集成的基础属性
...
func NewFrameDecoder(lf biface.LengthField) biface.IFrameDecoder {
...
func NewFrameDecoderByParams(maxFrameLength uint64, lengthFieldOffset, lengthFieldLength, lengthAdjustment, initialBytesToStrip int) biface.IFrameDecoder {
	return NewFrameDecoder(biface.LengthField{
