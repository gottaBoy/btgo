...
func NewLTV_Little_Decoder() biface.IDecoder {
	return &LTV_Little_Decoder{}
}

func (ltv *LTV_Little_Decoder) GetLengthField() *biface.LengthField {
	// +---------------+---------------+---------------+
	// |    Length     |     Tag       |     Value     |
...
func (ltv *LTV_Little_Decoder) Intercept(chain biface.IChain) biface.IcResp {
	...
	//blogger.Ins().DebugF("LTV-RawData size:%d data:%s\n", len(data), hex.EncodeToString(data))
